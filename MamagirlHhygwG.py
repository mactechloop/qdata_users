...
I Princess Uwaede Aifuwa. with registration number "null" is conducting a study on “Food Consumption Pattern of ……….. on Anthropometric Status of…..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/nfLFrfQGl5hbvb9wvFhev1NZOXo2/Questionnaires/MamagirlHhygwG/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/nfLFrfQGl5hbvb9wvFhev1NZOXo2/Questionnaires/MamagirlHhygwG/CollectedData/" + generateRandom())
