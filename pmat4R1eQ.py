...
st.write("""
    ...
    I Tolulope Ajadi  with registration number "null" is conducting a study on �Food Access among Student Households using 24 hr Open Recall Method �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/oOsp3Z6q59Ovh2ZPH8Pg0hUqVm23/Questionnaires/pmat4R1eQ/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/oOsp3Z6q59Ovh2ZPH8Pg0hUqVm23/Questionnaires/pmat4R1eQ/CollectedData/" + generateRandom())
