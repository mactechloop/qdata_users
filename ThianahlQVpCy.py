...
st.write("""
    ...
    I Ekundayo Christianah . with registration number "null" is conducting a study on ‘Food Access among Student Households using FFQ Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/Hto9z90ZdsZaF9xE77XUU7rLH002/Questionnaires/ThianahlQVpCy/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/Hto9z90ZdsZaF9xE77XUU7rLH002/Questionnaires/ThianahlQVpCy/CollectedData/" + generateRandom())
