...
st.write("""
    ...
    I Victoria Achonwa. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/WJ1bTf4RhQUPdSC16e5phadLPlx2/Questionnaires/zionK5Rayg/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/WJ1bTf4RhQUPdSC16e5phadLPlx2/Questionnaires/zionK5Rayg/CollectedData/" + generateRandom())
