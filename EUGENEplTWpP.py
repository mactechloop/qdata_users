...
st.write("""
    ...
    I EGHOSA OMOREGBEE . with registration number "null" is conducting a study on ‘Food Access among Student Households using Weighed Food Intake Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/G1WKQPSO52PB23wRThkAg5lj9fl2/Questionnaires/EUGENEplTWpP/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/G1WKQPSO52PB23wRThkAg5lj9fl2/Questionnaires/EUGENEplTWpP/CollectedData/" + generateRandom())
