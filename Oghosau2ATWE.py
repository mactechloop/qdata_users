...
st.write("""
    ...
    I Amy Osaretin. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/O2lFhbVoh6Y3oFkPzoFpLr566nj2/Questionnaires/Oghosa u2ATWE/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/O2lFhbVoh6Y3oFkPzoFpLr566nj2/Questionnaires/Oghosa u2ATWE/CollectedData/" + generateRandom())
