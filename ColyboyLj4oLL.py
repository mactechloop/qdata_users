...
st.write("""
    ...
    I Collins Amagwula. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/BuKTkS2Yx0PnVxP8kWs7msKGMBz1/Questionnaires/ColyboyLj4oLL/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/BuKTkS2Yx0PnVxP8kWs7msKGMBz1/Questionnaires/ColyboyLj4oLL/CollectedData/" + generateRandom())
