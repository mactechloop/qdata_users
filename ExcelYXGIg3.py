...
I Okpor Elizabeth chidimma with registration number "null" is conducting a study on ‘Anthropometric (BMI &waist-to-hip-ratio) status of …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/0Q7ygj2vx7fiFgRXJS9wp2pwT5W2/Questionnaires/ExcelYXGIg3/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/0Q7ygj2vx7fiFgRXJS9wp2pwT5W2/Questionnaires/ExcelYXGIg3/CollectedData/" + generateRandom())
