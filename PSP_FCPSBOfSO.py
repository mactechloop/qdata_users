...
I PATRICK SHAKA PROMISE. with registration number "null" is conducting a study on “Food Consumption Pattern of ……….. on Anthropometric Status of…..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/2PmoWenaRAf2GGOTplp2c8eUm7R2/Questionnaires/PSP_FCPSBOfSO/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/2PmoWenaRAf2GGOTplp2c8eUm7R2/Questionnaires/PSP_FCPSBOfSO/CollectedData/" + generateRandom())
