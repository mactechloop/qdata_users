...
st.write("""
    ...
    I Naonita Johnson with registration number "null" is conducting a study on �Food Access among Student Households using 24 hr Open Recall Method �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/8sYF2tRNHwbvMaX3hrjvmysuKXP2/Questionnaires/NaoxPuEhJ/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/8sYF2tRNHwbvMaX3hrjvmysuKXP2/Questionnaires/NaoxPuEhJ/CollectedData/" + generateRandom())
