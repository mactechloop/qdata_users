...
st.write("""
    ...
    I Onwualu Ekenedilichukwu . with registration number "null" is conducting a study on ‘Food Access among Student Households using FFQ Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/n1W8dQYiDBYEqnxSHuwQ4M7ftWA3/Questionnaires/Ekys3LW6g/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/n1W8dQYiDBYEqnxSHuwQ4M7ftWA3/Questionnaires/Ekys3LW6g/CollectedData/" + generateRandom())
