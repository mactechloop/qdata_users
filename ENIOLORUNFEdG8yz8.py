...
st.write("""
    ...
    I Promise Oke. with registration number "null" is conducting a study on ‘Food Access among Student Households using FFQ Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/HqRp9SNJuwgWkXLlhNwCJgFHTSR2/Questionnaires/ENIOLORUNFEdG8yz8/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/HqRp9SNJuwgWkXLlhNwCJgFHTSR2/Questionnaires/ENIOLORUNFEdG8yz8/CollectedData/" + generateRandom())
