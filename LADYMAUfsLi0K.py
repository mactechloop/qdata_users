...
st.title("Sensory Evaluation of Samples")

st.info('Questionnaire For MAUREEN GOWON')
st.text("___"*100)
st.write("""
## Dear Panelist
""")
...
if st.button("Submit Questionnare"):
    ...
    try:
        ref2 = db.reference("/Users/W8bCCqODsna2a8LjK5sYKYtvA5z2/Questionnaires/LADYMAU fsLi0K/Count")
        a = ref2.get()
        print(type(a))
        n_a = int(a) + 1
        ...
        ref = db.reference("/Users/W8bCCqODsna2a8LjK5sYKYtvA5z2/Questionnaires/LADYMAU fsLi0K/CollectedData/" + generateRandom())
