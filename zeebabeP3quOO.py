...
st.write("""
    ...
    I Idris Zainab. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/xbGcPlvswTXRHOfkX43P3WHJlZS2/Questionnaires/zeebabeP3quOO/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/xbGcPlvswTXRHOfkX43P3WHJlZS2/Questionnaires/zeebabeP3quOO/CollectedData/" + generateRandom())
