...
st.write("""
    ...
    I Ofe Arewah. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/t9tvQ8LDH2c4b2tEk6QmCbteq1x1/Questionnaires/Ofe's project yrgtz8/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/t9tvQ8LDH2c4b2tEk6QmCbteq1x1/Questionnaires/Ofe's project yrgtz8/CollectedData/" + generateRandom())
