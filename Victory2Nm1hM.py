...
st.write("""
    ...
    I Iyobosa Iyiriaro . with registration number "null" is conducting a study on ‘Food Access among Student Households using FFQ Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/2UWSEBpvAmdMhQ4wJTUgLnxcGtE2/Questionnaires/Victory 2Nm1hM/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/2UWSEBpvAmdMhQ4wJTUgLnxcGtE2/Questionnaires/Victory 2Nm1hM/CollectedData/" + generateRandom())
