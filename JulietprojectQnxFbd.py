...
st.write("""
    ...
    I Juliet Akinyemi Tunde. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/hC7KIxL49vZkdmE37ltNL7zK7Ad2/Questionnaires/Juliet projectQnxFbd/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/hC7KIxL49vZkdmE37ltNL7zK7Ad2/Questionnaires/Juliet projectQnxFbd/CollectedData/" + generateRandom())
