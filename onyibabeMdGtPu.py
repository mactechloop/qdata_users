...
st.write("""
    ...
    I  Onyinyechi Duru. with registration number "null" is conducting a study on ‘Food Access among Student Households using FFQ Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/YUyZrGJyXgaHOkBoTVpwHCGDVxn2/Questionnaires/onyibabeMdGtPu/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/YUyZrGJyXgaHOkBoTVpwHCGDVxn2/Questionnaires/onyibabeMdGtPu/CollectedData/" + generateRandom())
