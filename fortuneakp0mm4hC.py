...
st.write("""
    ...
    I Akponome Fortune . with registration number "null" is conducting a study on ‘Food Access among Student Households using Weighed Food Intake Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/xFf0CtWYhvVngyYSsp0zdtrDArC3/Questionnaires/fortune akp0mm4hC/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/xFf0CtWYhvVngyYSsp0zdtrDArC3/Questionnaires/fortune akp0mm4hC/CollectedData/" + generateRandom())
