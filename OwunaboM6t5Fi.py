...
st.write("""
    ...
    I  IBINGO OWUNABO ALAWARI. with registration number "null" is conducting a study on ‘Food Access among Student Households using FFQ Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/RHQBzgJ6noSuPvpgEVKafx0uwOW2/Questionnaires/OwunaboM6t5Fi/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/RHQBzgJ6noSuPvpgEVKafx0uwOW2/Questionnaires/OwunaboM6t5Fi/CollectedData/" + generateRandom())
