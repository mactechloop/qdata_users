...
if st.button("Submit Questionnare"):
    ...
    try:
        ref2 = db.reference("/Users/YrwERkcWGKdAcumQ0sEbF3FTx8h1/Questionnaires/BeccavOqjGl/Count")
        a = ref2.get()
        print(type(a))
        n_a = int(a) + 1
        ...
        ref = db.reference("/Users/YrwERkcWGKdAcumQ0sEbF3FTx8h1/Questionnaires/BeccavOqjGl/CollectedData/" + generateRandom())
