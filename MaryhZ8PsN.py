...
st.write("""
    ...
    I Joy Ayogho . with registration number "null" is conducting a study on ‘Food Access among Student Households using Weighed Food Intake Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/rrjTlikoVQQil4DyZik86kUyaW32/Questionnaires/MaryhZ8PsN/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/rrjTlikoVQQil4DyZik86kUyaW32/Questionnaires/MaryhZ8PsN/CollectedData/" + generateRandom())
