...
st.write("""
    ...
    I Success Afelomo. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/d7bP19dtgfQ0GuG2e9CtZ88gnnT2/Questionnaires/Mary 2l80N8/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/d7bP19dtgfQ0GuG2e9CtZ88gnnT2/Questionnaires/Mary 2l80N8/CollectedData/" + generateRandom())
