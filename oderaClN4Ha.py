...
st.write("""
    ...
    I Uchechi Faith. with registration number "null" is conducting a study on ‘Dietary Diversity of Women (15-49 years) using 24 hr Open Recall Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/494OcEdrgag9dXBVoyoNjuyzLsk2/Questionnaires/oderaClN4Ha/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/494OcEdrgag9dXBVoyoNjuyzLsk2/Questionnaires/oderaClN4Ha/CollectedData/" + generateRandom())
