...
st.write("""
    ...
    I Cyrus Osamudiamen. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/Gs9r5f85DWRmuWDawjRkq6Yuv2t2/Questionnaires/cyrusproject5Rcj2c/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/Gs9r5f85DWRmuWDawjRkq6Yuv2t2/Questionnaires/cyrusproject5Rcj2c/CollectedData/" + generateRandom())
