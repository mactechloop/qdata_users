...
st.write("""
    ...
    I Irene Atiati. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/rILLvhmYnCR3BeH8Uo415ncmBNx2/Questionnaires/VomeH5LsE6/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/rILLvhmYnCR3BeH8Uo415ncmBNx2/Questionnaires/VomeH5LsE6/CollectedData/" + generateRandom())
