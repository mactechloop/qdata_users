...
st.write("""
    ...
    I Okechukwu Ebube with registration number "null" is conducting a study on �Food Access among Student Households using 24 hr Open Recall Method �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/6GwufdsTtQY9sK9phskMqlZ3ePu2/Questionnaires/Bubuqo61If/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/6GwufdsTtQY9sK9phskMqlZ3ePu2/Questionnaires/Bubuqo61If/CollectedData/" + generateRandom())
