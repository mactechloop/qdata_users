...
st.write("""
    ...
    I Daniella ojeyokan with registration number "null" is conducting a study on �Food Access among Student Households using 24 hr Open Recall Method �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/Vha2duIVoucFGe6dnpCwcIozka73/Questionnaires/DanigagapZw9og/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/Vha2duIVoucFGe6dnpCwcIozka73/Questionnaires/DanigagapZw9og/CollectedData/" + generateRandom())
