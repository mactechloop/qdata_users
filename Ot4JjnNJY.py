...
st.info('Questionnaire For Omonye Otaifoh')
st.text("___"*100)
st.write("""
## Dear Panelist
""")
...
if st.button("Submit Questionnare"):
    ...
    try:
        ref2 = db.reference("/Users/I5Ut8iXwr7dRtwE4KwAf3kouvOW2/Questionnaires/Ot4JjnNJY/Count")
        a = ref2.get()
        print(type(a))
        n_a = int(a) + 1
        ...
        myData = {
            generateRandom() : {
                "Sample": "1, 2, 3, 4",
                "Taste": str([a1, b1, c1, d1]),
                "Texture": str([a2, b2, c2, d2]),
                "Appearance": str([a3, b3, c3, d3]),
                "Aroma": str([a4, b4, c4, d4]),
                "General Acceptability": str([a5, b5, c5, d5]),
                "Pendant":  str([int(n_a), int(n_a), int(n_a), int(n_a)])
            }
        }
        ...
        ref = db.reference("/Users/I5Ut8iXwr7dRtwE4KwAf3kouvOW2/Questionnaires/Ot4JjnNJY/CollectedData/" + generateRandom())
