...
st.write("""
    ...
    I Uchechi Chidozie. with registration number "null" is conducting a study on ‘Dietary Diversity of Women (15-49 years) using 24 hr Open Recall Method …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/vWGd8S5wbzeh3TLTzIHJlq5NQwx1/Questionnaires/faith Chidoziei9ldtD/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/vWGd8S5wbzeh3TLTzIHJlq5NQwx1/Questionnaires/faith Chidoziei9ldtD/CollectedData/" + generateRandom())
