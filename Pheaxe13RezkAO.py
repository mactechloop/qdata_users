    ...
    try:
        ...
        myData = {
            generateRandom() : {
                ...
                "Taste": str([a1, b1, c1, d1, e1, f1, g1, h1, i1, j1, k1, l1, m1]),
                "Texture": str([a2, b2, c2, d2, e2, f2, g2, h2, i2, j2, k2, l2, m2]),
                "Appearance": str([a3, b3, c3, d3, e3, f3, g3, h3, i3, j3, k3, l3, m3]),
                "Aroma": str([a4, b4, c4, d4, e4, f4, g4, h4, i4, j4, k4, l4, m4]),
                "General Acceptability": str([a5, b5, c5, d5, e5, f5, g5, h5, i5, j5, k5, l5, m5]),
