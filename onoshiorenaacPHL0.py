...
I Oshiotse Mercy with registration number "null" is conducting a study on ‘Anthropometric (BMI &waist-to-hip-ratio) status of …..”. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/xHgqT8R1HuZPWF2YnwlUNfPcp4y1/Questionnaires/onoshiorenaacPHL0/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/xHgqT8R1HuZPWF2YnwlUNfPcp4y1/Questionnaires/onoshiorenaacPHL0/CollectedData/" + generateRandom())
