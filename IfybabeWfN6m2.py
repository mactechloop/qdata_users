...
st.write("""
    ...
    I Ifeyinwa Aneke. with registration number "null" is conducting a study on �Food Cost on Food Choice & BMI status of �..�. 
...
if st.button("Submit Questionnare"):
    ...
    ref2 = db.reference("/Users/FWZf6mpcqXYxM0XvJHFWzGeZD6E3/Questionnaires/IfybabeWfN6m2/Count")
    a = ref2.get()
    n_a = int(a) + 1
    ...
    ref = db.reference("/Users/FWZf6mpcqXYxM0XvJHFWzGeZD6E3/Questionnaires/IfybabeWfN6m2/CollectedData/" + generateRandom())
